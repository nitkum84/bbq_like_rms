...
<div class="page-header">
    <h1 class="page-title">Add Deal / Bundle</h1>
    <a href="{{ route('admin.deals-bundles.index') }}" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i>Back</a>
</div>
    ...
    <div class="col-lg-9">
        <div class="admin-card">
            ...
            <div class="admin-card-body">
                <form action="{{ route('admin.deals-bundles.store') }}" method="POST">
                    @csrf
                    @include('admin.deals-bundles._form', ['submitLabel' => 'Save Deal'])
                </form>
            </div>
        </div>
    </div>
